...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--num_agents", nargs='+', type=int, default=[4, 8, 16, 32, 64, 128, 256],
                        help="number of agents in the env")
    parser.add_argument("-s", "--env_size", nargs='+', type=int, default=[40, 80], help="env size")
    parser.add_argument("-d", "--obs_dense", nargs='+', type=float, default=[0.3, 0.65],
                        help="obstacle density of the env")
    parser.add_argument("-w", "--wall_component", nargs='+', type=int, default=[1, 6],
                        help="average length of each wall")
    parser.add_argument("-t", "--num_tests", type=int, default=1, help="number of tests per env setting")
